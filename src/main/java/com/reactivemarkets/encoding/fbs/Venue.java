...
public final class Venue extends Table {
    public static Venue getRootAsVenue(ByteBuffer _bb) {
        return getRootAsVenue(_bb, new Venue());
    }

    public static Venue getRootAsVenue(ByteBuffer _bb, Venue obj) {
    ...
    public static void startVenue(FlatBufferBuilder builder) {
        builder.startObject(4);
    }
    ...
    public static void addFlags(FlatBufferBuilder builder, int flags) {
        builder.addShort(3, (short) flags, (short) 0);
    }
    ...
    public Venue __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
