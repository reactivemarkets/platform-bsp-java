...
public final class FixMaker extends MessageCracker implements Application {
    ...
    /**
     * This callback notifies you when a valid logon has been established with a counter party. This
     * is called when a connection has been established and the FIX logon process has completed with
     * both parties exchanging valid logon messages.
     *
     * @param sessionId QuickFIX session ID
     */
    @Override
    ...
    /**
     * This callback notifies you when an FIX session is no longer online. This could happen during
     * a normal logout exchange or because of a forced termination or a loss of network connection.
     *
     * @param sessionId QuickFIX session ID
     */
    @Override
    ...
    /**
     * This callback provides you with a peek at the administrative messages that are being sent
     * from your FIX engine to the counter party. This is normally not useful for an application
     * however it is provided for any logging you may wish to do. You may add fields in an
     * adminstrative message before it is sent.
     *
    ...
    /**
     * This callback notifies you when an administrative message is sent from a counterparty to your
     * FIX engine. This can be usefull for doing extra validation on logon messages such as for
     * checking passwords. Throwing a RejectLogon exception will disconnect the counterparty.
     *
     * @param message QuickFIX message
     * @param sessionId QuickFIX session ID
     * @throws FieldNotFound field not found
     * @throws IncorrectDataFormat incorrect data format
     * @throws IncorrectTagValue incorrect tag value
    ...
    /**
     * This is a callback for application messages that you are sending to a counterparty. If you
     * throw a DoNotSend exception in this function, the application will not send the message. This
     * is mostly useful if the application has been asked to resend a message such as an order that
     * is no longer relevant for the current market. Messages that are being resent are marked with
     * the PossDupFlag in the header set to true; If a DoNotSend exception is thrown and the flag is
     * set to true, a sequence reset will be sent in place of the message. If it is set to false,
     * the message will simply not be sent. You may add fields before an application message before
     * it is sent out.
     *
     * @param message QuickFIX message
     * @param sessionId QuickFIX session ID
    ...
    /**
     * This callback receives messages for the application. This is one of the core entry points for
     * your FIX application. Every application level request will come through here. If, for
     * example, your application is a sell-side OMS, this is where you will get your new order
     ...
     * @throws IncorrectDataFormat incorrect data format
     * @throws IncorrectTagValue incorrect tag value
     * @throws UnsupportedMessageType unsupported message type
     */
    @Override
